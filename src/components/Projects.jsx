...
const Projects = () => {
  const projectJson = [
    {
      title: "E-Commerce Store",
      desc: "Modern online furniture store with dynamic products, authentication, cart, and Razorpay integration.",
      github: "https://github.com/kasimtp/E-commerce-furniture",
      live: "https://e-commerce-furniture-hhmq.vercel.app/",
      tech: ["React", "Tailwind", "Vite", "Razorpay"],
      accent: "text-blue-600", // Custom accent for each project
    },
    {
      title: "To-Do List App",
      desc: "Interactive to-do list app with local storage, responsive UI, and smooth animations.",
      github: "https://github.com/kasimtp/Todolist.git",
      live: "https://kasimtp.github.io/Todolist/",
      tech: ["React", "Tailwind", "LocalStorage"],
    ...
    {
      title: "Weather App",
      desc: "Real-time weather forecast app using OpenWeather API, clean UI, and responsive design.",
      github: "https://github.com/kasimtp/weather-app",
      live: "https://kasimtp.github.io/weather-app/",
      tech: ["JavaScript", "CSS", "HTML"],
    ...
    {
      title: "Portfolio Website",
      desc: "Personal portfolio showcasing projects and skills, built with Next.js and Framer Motion.",
      github: "https://github.com/kasimtp/portfolio",
      live: "https://portfoliokasim.vercel.app/",
      tech: ["Next.js", "Tailwind", "Framer Motion"],
  ...
  return (
    <section
      id="projects"
      className="bg-slate-50 text-gray-800 py-24 px-4 font-sans" // Match light background
    >
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <motion.div
        ...
        >
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            A selection of my recent works, ranging from full-stack e-commerce platforms to sleek interactive tools.
          </p>
        </motion.div>

        {/* Projects Grid */}
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-2"> {/* Increased gap for light UI */}
          {projectJson.map((item, index) => (
            <motion.div
              key={index}
              ...
              whileHover={{ y: -8 }}
              className="bg-white border border-gray-100 rounded-3xl p-8 flex flex-col justify-between shadow-sm hover:shadow-xl transition-all duration-300"
            >
              <div>
                {/* Title */}
                <h3 className={`text-2xl font-bold mb-3 ${item.accent}`}>
                  {item.title}
                </h3>
              ...
              <div className="flex items-center gap-4 mt-auto">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-2 text-sm font-semibold px-5 py-2.5 rounded-xl bg-gray-900 text-white hover:bg-black transition shadow-md"
                >
                ...
                {item.live && (
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 text-sm font-semibold px-5 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 transition shadow-sm"
                  >
                    <PiEye className="text-xl" /> Live Demo
                  </motion.a>
                )}
              </div>
            </motion.div>
